jQuery(document).ready(function ($) {
  ...
  if ($('li.menu-item-has-children').length) {
    $("li.menu-item-has-children > a").after('<button type="button" class="arrow" tabindex="-1"></button>');

    $("li.menu-item-has-children > a[rel]").each(function(index, value){
      $(this).parents('li.menu-item-has-children').find('ul.sub-menu').attr('data-rel', this.rel);
    });
  }
...
jQuery.fn.accessibleDropDown = function() { 
  jQuery("#main-menu a").focus(function() {
