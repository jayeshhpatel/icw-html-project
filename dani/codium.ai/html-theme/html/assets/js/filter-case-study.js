(function($) {
	...
	$doc.ready( function() {
		 ...
		 * Retrieve posts
		 */
		function get_posts_case_study($params) {
			...
			$.ajax({
				...
				complete: function(data, textStatus) {
					...
					if (msg === 'No posts found') {
						$content.html('<li>&nbsp;</li><li class="text-center pt-50 pb-50"><div class="alert alert-danger">No case study found.</div></li><li>&nbsp;</li>');
					}
		...
		/**
		 * Bind get_posts_case_study to tag cloud and navigation
		 */
